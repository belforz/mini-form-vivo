          ...
          <div className="slideshow-content relative w-full h-[300px] md:h-[400px] overflow-hidden">
            {keys.map((key, index) => (
              ...
              >
                ...
                />
                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-purple-800 via-transparent to-transparent text-white p-6 shadow-md"> <h2 className="flex items-center justify-center text-2xl text-black font-bold">{slideshowImages[key].name}</h2>
